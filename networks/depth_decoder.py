...
class MPViMDepthDecoder(nn.Module):
    def __init__(self, encoder, scales=range(4), num_output_channels=1, use_skips=True):
        super(MPViMDepthDecoder, self).__init__()

        encoder_channel_dict={"tiny":[64, 96, 176, 216, 216]}
        self.num_output_channels = num_output_channels
        self.use_skips = use_skips
        self.upsample_mode = 'nearest'
        self.scales = scales

        self.num_ch_enc = encoder_channel_dict[encoder]
        self.num_ch_dec = np.array([32, 64, 96, 176, 216])
